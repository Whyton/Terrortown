...
@XmlRootElement(name = "berechneInhalt", namespace = "http://www.axxg.de/ws/rechteck")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "berechneInhalt", namespace = "http://www.axxg.de/ws/rechteck", propOrder = {
    "laenge",
    "breite"
})
public class BerechneInhalt {
