...
public class ObjectFactory {
    ...
    private final static QName _MakeMessageResponse_QNAME = new QName("http://www.axxg.de/ws/rechteck", "makeMessageResponse");
    ...
    private final static QName _MakeMessage_QNAME = new QName("http://www.axxg.de/ws/rechteck", "makeMessage");
    ...
    /**
     * Create an instance of {@link MakeMessage }
     * 
     */
    public MakeMessage createMakeMessage() {
        return new MakeMessage();
    }
    ...
    /**
     * Create an instance of {@link MakeMessageResponse }
     * 
     */
    public MakeMessageResponse createMakeMessageResponse() {
        return new MakeMessageResponse();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link MakeMessageResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.axxg.de/ws/rechteck", name = "makeMessageResponse")
    public JAXBElement<MakeMessageResponse> createMakeMessageResponse(MakeMessageResponse value) {
        return new JAXBElement<MakeMessageResponse>(_MakeMessageResponse_QNAME, MakeMessageResponse.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link MakeMessage }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.axxg.de/ws/rechteck", name = "makeMessage")
    public JAXBElement<MakeMessage> createMakeMessage(MakeMessage value) {
        return new JAXBElement<MakeMessage>(_MakeMessage_QNAME, MakeMessage.class, null, value);
    }
